...
Source: [microsoft/copilot-camp](https://github.com/microsoft/copilot-camp). This is an upstream fork, not original authorship.
Purpose: Microsoft 365 declarative-agent learning paths and prerequisite guidance.
License: upstream MIT. Preserve LICENSE, copyright notices, and any asset-specific terms.
Snapshot before curator additions: `30c48b468d51661c7de2ad93ac2fbcf9a8fbc9ea`.

## Start here

Recommended starting point: **Agent Builder on-ramp**.
Prerequisites: Agent Builder or current Agents Toolkit plus appropriate tenant licenses.
...
`["docs"]` plus `.github` and root files. Excluded files remain
